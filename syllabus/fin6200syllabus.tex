...
\documentclass[fontsize=11,english,letterpaper, abstracton, abstract=false, titlepage=false, headings=normal, captions=tableheading, numbers=noenddot]{scrartcl}
\usepackage{fourier}
\usepackage{berasans}
...
\date{Spring 2026\thanks{Information is subject to change. This version updated \today.}}
...
meeting times are 9:45\textendash 11:\textsc{00am}, 11:15\textsc{am}\textendash 12:\textsc{30pm},
or 1:45\textendash 3:\textsc{00pm}.
...
\item Office hours: By Appointment in Tomasso 320 or via Webex
\end{itemize}
...
ways
\begin{description}
\item [{Canvas}] The course \href{https://babson.instructure.com/courses/7773643}{Canvas site}
...
environment (Visual Studio Code is recommended).
\item Access to one or more generative AI/LLM tools. This is an evolving
landscape and that while no specific tool is required, I expect students
to be open minded and flexible about trying new tools, and expect
them to collaborate in helping share effective approaches with classmates
in a collaborative learning environment. Taking advantage of these
tools may involve paid software subscriptions, but many tools are
available on a free or free trial basis to students.
\end{enumerate}
...
\begin{itemize}
\item ``Introduction to Modern Statistics'' (2nd~ed.), Mine Çetinkaya-Rundel
and Johanna Hardin. Freely available on web, or purchase PDF or print
edition.
\item ``Think Python'' (3rd~ed.), Allen B. Downey. Freely available on
web, or purchase print edition. This is recommended for new Python
programmers, and especially those without much programming experience
generally.
\end{itemize}
...
Python texts.
\item ``Python Data Science Handbook'' (2nd ed.), Jake VanderPlas. Freely
available on web, or purchase print edition. A key resource and reference
for moving from basic python into more analysis-focused tools.
...
advice on setting up a technology stack.
\end{itemize}
...
Datasets'' (v.~3.0), Joseph M. Manzo. Available only for purchase
...
Homework & Independent work & 0\% & Throughout\tabularnewline
Midterm group project & Online submission{*}

and & 10\% & \begin{cellvarwidth}[t]
\centering
{*}2/17

2/18
\end{cellvarwidth}\tabularnewline
Midterm examination & In-person examination & 15\% & \begin{cellvarwidth}[t]
\centering
2/27

\textsc{9am}\textendash 12\textsc{pm}
\end{cellvarwidth}\tabularnewline
Professional ethics module & In class participation and

online submission{*} & 10\% & \begin{cellvarwidth}[t]
\centering
3/4 and 4/1

{*}3/31
\end{cellvarwidth}\tabularnewline
Data/methods demonstration & Online submission{*}
...
4/6\textendash 8
\end{cellvarwidth}\tabularnewline
Final group project & Online submission{*}

and & 15\% & \begin{cellvarwidth}[t]
\centering
{*}4/21

4/22\textendash 24
\end{cellvarwidth}\tabularnewline
Final examination & In-person examination & 20\% & \begin{cellvarwidth}[t]
\centering
5/4 or 5/6
...
Approximately eight homework assignments will be posted on Canvas.
Homework will not be collected or graded, but you should be prepared
to discuss homework assignments in class any time after their due
date (an element of strong class participation and professionalism).

\emph{Homework assignments are designed for learning, not assessment.}
...
A midterm project will be assigned and submitted via Canvas. You may
also be required to present your findings in class.
...
module on professional ethics on 3/4 and 4/1. \noun{In-class attendance
...
assessment. You must complete it entirely independently. The assignment
will offer specific guidance on allowable use of resources including
generative software (e.g., AI assistants or ``copilots''). You should
only use tools and sources that are allowed, and should clearly cite
any that contributed to your work. You are explicitly prohibited from
accessing or consulting prior-year Finance~6200 ethics modules assignments
or solutions (including either students' or sample solutions), unless
distributed to the class by the instructor.}
...
plan to attend all class sessions,\footnote{Please however note Section~\ref{subsec:Accommodations} on accommodations,
